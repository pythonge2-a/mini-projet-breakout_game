...
class bolus:
    ...
    def __init__(self, screen, breakout, racket, speed=C.BONUS_SPEED, brick = None, bonus = False, malus = False):
        self.screen = screen
    ...
    def check_take(self) :
        ...
        if (((bm_x - bm_w) < (r_x + r_w)) and ((bm_x + bm_w) > (r_x - r_w))) and (((bm_y - bm_h) < (r_y + r_h)) and ((bm_y + bm_h) > (r_y - r_h))) :
            return True
        else :
            return False
