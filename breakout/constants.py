...
# TILESET #
TILESET_PATH = "breakout/tileset/Tileset couleurV2.1.png"
TILESET_BRICKS_POS = [1, 1]
TILESET_BRICKS_SIZE = [78, 30]

TILESET_BALLS_POS = [396, 1]
TILESET_BALLS_SIZE = [10, 10]

TILESET_RACKETS_POS = [396, 32]
TILESET_RACKETS_SIZE = [RACKET_WIDTH, RACKET_HEIGHT]

TILESET_BONUSES_POS = [10, 20]
TILESET_BONUSES_SIZE = [15, 15]
